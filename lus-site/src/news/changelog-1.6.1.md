...
Lus 1.6.1 is a maintenance release: a focused set of memory-safety, concurrency, and security fixes on top of 1.6.0. Bytecode is unchanged, so 1.6.0 compiled chunks remain compatible.
