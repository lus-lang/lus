...
In addition to the compile time attributes, local variables can also be given runtime attributes to specialize their assignment behavior.
...
local x <printvar> = 10 -- prints "x 10"
printvar = nil
x = 20 -- prints "x 20", printvar is cached
