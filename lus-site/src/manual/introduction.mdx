...
This language was developed out of a need to bring Lua into the world of general-purpose programming. Lua focuses on embeddability first and runtime second, which has historically resulted in its limited standard library and programmer dependence on third-party packages for even the most basic of tasks. However, even as we depart from Lua's simple scope, we still wish to retain its consiceness.
